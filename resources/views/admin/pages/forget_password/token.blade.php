            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Please input the 8-code Token that was send to email : {{$user->email}}</p>
                        ...
                        @endif
                        <form id="formAuthentication" class="mb-3" action="{{url('token_forget_password_admin')}}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="email" class="form-label">Token</label>
                                <input type="text" class="form-control" id="email" name="token"
                                    placeholder="8-Code Token" autofocus />
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit">SUBMIT TOKEN</button>
                            </div>
                        </form>
