            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Please Input your <b>New Password</b></p>
                        ...
                        @endif
                        <form id="formAuthentication" class="mb-3" action="{{url('save_forget_password_admin')}}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="confirm" class="form-label">New Password Confirmation</label>
                                <input type="password" class="form-control" id="confirm" name="password_confirmation"
                                    placeholder="New Password Confirmation" autofocus />
                                
                            </div>
                            <input type="hidden" value="{{$user->email}}" name="email"/>
                            <input type="hidden" value="{{$user->id}}" name="user_id"/>
                            <input type="hidden" value="{{$check->id}}" name="request_id"/>
                            <input type="hidden" value="{{$check->token}}" name="token"/>
                            <div class="mb-3">
