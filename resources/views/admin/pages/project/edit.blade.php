                                                ...
                                                {{-- <div class="mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="minimum" class="form-control @error("minimum")
                                                            is-invalid @enderror" id="basic-icon-default-fullname"
                                                            placeholder="John Doe" value="{{$data->minimum}}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                ...
                                                                <input type="date" id="basic-icon-default-company"
                                                                    name="date_posted" value="{{date('Y-m-d',strtotime($data->date_posted))}}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                ...
                                                                <input type="date" id="basic-icon-default-email"
                                                                    name="valid_until" value="{{date('Y-m-d',strtotime($data->valid_until))}}"
