                                    ...
                                    <form action="{{route('user.update',$data->id)}}" method="POST">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="basic-icon-default-fullname">Level  <span style="font-size:11px;text-transform:lowercase" class="text-danger">(readonly)</span></label>
                                                    <div class="input-group input-group-merge">
                                                        <span id="basic-icon-default-fullname2"
                                                            class="input-group-text"><i class="bx bx-envelope"></i></span>
                                                        <input type="text" class="form-control @error("level")
                                                            is-invalid @enderror" id="basic-icon-default-fullname" readonly
                                                            placeholder="John Doe" value="{{$data->level}}"
                                                            aria-label="John Doe" name="level"
                                                            aria-describedby="basic-icon-default-fullname2" />
                                                    </div>
                                                </div>
