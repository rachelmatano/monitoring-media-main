...
<style>
    ...
    #myImg:hover,#myVideoPlace:hover {
        opacity: 0.7;
    }
                    ...
                    <div class="col-sm-12">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <a style="float:right" href="{{url('prove_gallery_add/'.$data->id)}}"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="table-responsive">
                                                    ...
                                                    <table width="100%" class="table table-striped table-bordered">
                                                        ...
                                                        @else
                                                        <tr><th colspan='2' style="color:red;"> Media Has been Deleted!</th></tr>
                                                        @endif
                                                    </table>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="table-responsive">
                                                    <table width="100%" class="table table-striped table-bordered">
                                                        ...
                                                        @else
                                                        <tr><th colspan='2' style="color:red;">Reporter has been deleted!</th></tr>
                                                        @endif
                                                    </table>
                                                </div>
                                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        @else
                                        <tr><th style="color:red;">Project Has been deleted!</th></tr>
                                        @endif
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="card">
                                        ...
                                        @else
                                        <img class="card-img-top" id="myVideoPlace" onclick="javascript:videoClick(this)" data-src="{{asset('prove_galleries/'.$g->link_path)}}"
                                            alt="{{$media->m_name??'-'}}" src="{{asset('video.png')}}"
                                            width="100%"
                                            style="max-height: 200px;min-height:200px;object-fit:cover;object-align:center" />
                                        @endif
                                        <div class="card-footer">
                                            <form action="{{ url('prove_gallery/'. $g->id) }}" method="post">
                                                @csrf
                                                @method('delete')
...
<div id="myVideo" class="modal">
    ...
    <!-- Modal Content (The Image) -->
    <video class="modal-content" id="vid" controls>
        <source src="" type="video/mp4">
    </video>

    <!-- Modal Caption (Image Text) -->
    <div id="captionVideo"></div>
</div>
<script>
    ...
    var modalVideoPlace = document.getElementById("myVideo");

    // Get the image and insert it inside the modal - use its "alt" text as a caption
    var video = document.getElementById("myVideoPlace");
    var modalVideo = document.getElementById("vid");
    var captionVideo = document.getElementById("captionVideo");
    function videoClick(video) {
        // alert(video.dataset.src);
        modalVideoPlace.style.display = "block";
        modalVideo.src = video.dataset.src;
        captionVideo.innerHTML = video.alt;
    }
    ...
    // When the user clicks on <span> (x), close the modal
    modalVideoPlace.onclick = function () {
        modalVideoPlace.style.display = "none";
    }
</script>
@endsection
