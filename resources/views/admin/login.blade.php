...
<head>
    ...
    <title>Login Kominfo Minahasa Media Contribution</title>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="{{url('login-reporter')}}" class="app-brand-link gap-2">
                        ...
                        <p class="mb-4">to Admin Kominfo Minahasa, Please sign-in to your account </p>
                        ...
                        @endif
                        <form id="formAuthentication" class="mb-3" action="{{route('login.validate.admin')}}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3 form-password-toggle">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{url('/forget_password_admin')}}">
