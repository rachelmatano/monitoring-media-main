<head>
    ...
    <title>Dashboard - KOMINFO MINAHASA MEDIA CONTRIBUTION</title>
    ...
    <link rel="stylesheet" href="{{asset('/sneat-bootstrap-html/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
