        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">to Kominfo Minahasa, Please sign-in to your account </p>

              <form id="formAuthentication" class="mb-3" action="{{route('login.validate.reporter')}}" method="POST">
                @csrf
                <div class="mb-3">
